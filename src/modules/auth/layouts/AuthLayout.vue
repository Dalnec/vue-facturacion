<template>
  ...
  <div class="bg-gray-100 flex justify-center items-center h-screen">
    <!-- Left: Image -->
    <div
      class="w-1/2 h-screen hidden lg:flex justify-center items-center bg-primary"
    >
      <div class="flex flex-col items-center">
        <!-- SVG Icon -->
        <!-- <svg
          class="w-1/2 h-1/2 icon-glow"
          viewBox="0 0 24 24"
          fill="none"
        ...
        <img src="/icon-facturacion.png" alt="logo" class="w-1/2 h-1/2" />
        <h1 class="text-5xl font-semibold text-white mt-4 mx-8">
...
@keyframes glow {
  0% {
    filter: drop-shadow(0 0 5px #dbecf5);
  }
  50% {
    filter: drop-shadow(0 0 10px #dbecf5);
  }
  100% {
    filter: drop-shadow(0 0 5px #dbecf5);
  }
